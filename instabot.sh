C #!/bin/bash
# Instabot by Coding Kashmir
# recoded by: Sajid Banday
# github.com/BandaySajid/instabot
...
printf "      \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m coded by sajid banday (thanks to Coding Kashmir )\e[0m\n"
}
